...
const HEADER_SYNONYMS: Record<string, string[]> = {
  bus_no: ["vehicle no", "vehicle number", "bus no", "bus number", "reg no", "registration", "reg. no"],
  vehicle_name: ["vehicle name", "name"],
  vehicle_brand: ["vehicle brand", "brand", "make"],
  permit_no: ["permit no", "permit number", "permit"],
  permit_category: ["permit catagory", "permit category", "permit cat"],
  capacity: ["seating capacity", "capacity", "seats"],
  chassis_number: ["chassie no", "chassis no", "chassis number", "chassie number"],
  engine_number: ["engine no", "engine number"],
  type: ["usage type", "usage", "type"],
  route: ["allocation route", "route", "allocated route"],
  year: ["yom", "year of manufacture", "year"],
  owner_name: ["ownership", "owner", "owner name", "owner's name"],
  owner_address: ["owner's address", "owner address", "address"],
  owner_nic: ["owner's id", "owner id", "nic", "owner nic"],
  leasing_bank: ["leasing bank", "leasing", "bank"],
  leasing_end_date: ["leasing end date", "leasing end", "lease end"],
  permit_expiry_date: ["permit expiry date", "permit expiry", "permit expire"],
  revenue_license_expiry: ["revenue expire", "revenue expiry", "revenue license", "revenue licence"],
  insurance_company: ["insurence company", "insurance company", "insurer"],
  insurance_expiry: ["insurence expiry date", "insurance expiry date", "insurance expiry", "insurence expiry"],
  default_driver_name: ["driver name", "driver"],
  driver_phone: ["phone number", "phone", "driver phone", "contact"],
};
