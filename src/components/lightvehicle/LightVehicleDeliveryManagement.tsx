...
import { useLightVehicleDeliveryManagement } from '@/hooks/useLightVehicleDeliveryManagement';
import { format } from 'date-fns';

interface LightVehicleDeliveryManagementProps {
  onRefresh: () => void;
}

export function LightVehicleDeliveryManagement({ onRefresh }: LightVehicleDeliveryManagementProps) {
  const {
    isLoading,
  ...
  } = useLightVehicleDeliveryManagement();
