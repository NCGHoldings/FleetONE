...
import { LightVehicleImageUploader } from './LightVehicleImageUploader';
import {
  DragDropContext,
  Droppable,
  Draggable,
...
interface LightVehicleImageManagerProps {
  busModelId: string;
  busModelName: string;
  isOpen: boolean;
  onClose: () => void;
...
export function LightVehicleImageManager({ 
  busModelId, 
  busModelName,
  isOpen, 
  onClose,
  onUpdate 
}: LightVehicleImageManagerProps) {
