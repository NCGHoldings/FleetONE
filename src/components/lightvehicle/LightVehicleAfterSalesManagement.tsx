...
import { useLightVehicleAfterSalesManagement } from '@/hooks/useLightVehicleAfterSalesManagement';
import { format } from 'date-fns';

interface LightVehicleAfterSalesManagementProps {
  onRefresh: () => void;
}

export function LightVehicleAfterSalesManagement({ onRefresh }: LightVehicleAfterSalesManagementProps) {
  const {
    isLoading,
    getWarranties,
    getServiceReminders,
  ...
  } = useLightVehicleAfterSalesManagement();
