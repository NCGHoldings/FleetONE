...
import { useLightVehicleSupplierManagement, LightVehicleSupplierOrder, ProductionUpdate } from '@/hooks/useLightVehicleSupplierManagement';

interface LightVehicleSupplierOrderDetailsModalProps {
  supplierOrder: LightVehicleSupplierOrder;
  open: boolean;
  onClose: () => void;
  onRefresh: () => void;
}

export function LightVehicleSupplierOrderDetailsModal({
  supplierOrder,
  open,
  onClose,
  onRefresh
}: LightVehicleSupplierOrderDetailsModalProps) {
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label>LightVehicle Reference</Label>
                    <div className="font-mono text-sm mt-1">
                      {supplierOrder.lightvehicle_order_reference || 'Not assigned'}
                    </div>
                  </div>
