...
import { LightVehicleBusModelProfile } from './LightVehicleBusModelProfile';
import { LightVehicleImageManager } from './LightVehicleImageManager';
...
export function LightVehicleBusModelsAdmin() {
  ...
  if (loading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>LightVehicle Bus Models</CardTitle>
        </CardHeader>
        <CardContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="e.g., LightVehicle ZK6129H" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
