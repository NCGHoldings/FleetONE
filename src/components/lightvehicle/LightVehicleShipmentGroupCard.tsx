...
import { ShipmentGroup } from '@/hooks/useLightVehicleShipmentGroupManagement';
import { LightVehicleOrderCard } from './LightVehicleOrderCard';
...
interface LightVehicleShipmentGroupCardProps {
...
export function LightVehicleShipmentGroupCard({
  shipment,
  onEdit,
  onDelete,
  onAddOrders,
  onBulkUpdate,
  onViewOrder
}: LightVehicleShipmentGroupCardProps) {
