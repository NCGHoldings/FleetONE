...
import { useLightVehicleShipmentGroupManagement, ShipmentGroup, CreateShipmentGroupData } from '@/hooks/useLightVehicleShipmentGroupManagement';

interface LightVehicleCreateShipmentGroupModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export function LightVehicleCreateShipmentGroupModal({
  open,
  onClose,
  onSuccess,
  editShipment
}: LightVehicleCreateShipmentGroupModalProps) {
  const isEditing = !!editShipment;
  const { createShipmentGroup, updateShipmentGroup, isLoading } = useLightVehicleShipmentGroupManagement();
