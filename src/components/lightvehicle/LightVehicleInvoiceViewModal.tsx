...
import { generateLightVehicleInvoiceHTML, type LightVehicleInvoiceData } from '@/lib/lightvehicle-invoice-generator';
import { useLightVehicleInvoiceManagement, type LightVehicleStoredDocument } from '@/hooks/useLightVehicleInvoiceManagement';
...
interface LightVehicleInvoiceViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  invoiceDocument: LightVehicleStoredDocument;
  invoiceData: LightVehicleInvoiceData;
  onRefresh?: () => void;
}

export const LightVehicleInvoiceViewModal: React.FC<LightVehicleInvoiceViewModalProps> = ({
  isOpen,
  onClose,
  invoiceDocument,
  invoiceData,
  ...
  const { approveInvoice, regenerateInvoice, isLoading } = useLightVehicleInvoiceManagement();
  ...
  const displayData: LightVehicleInvoiceData = {
    ...invoiceData,
  ...
  const handlePrint = () => {
    const htmlContent = generateLightVehicleInvoiceHTML(displayData);
        ...
        <DialogHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            <DialogTitle className="text-xl font-semibold">
              LightVehicle Invoice - {invoiceData.invoiceNo}
            </DialogTitle>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 overflow-hidden">
          ...
          <TabsContent value="preview" className="flex-1 overflow-hidden">
            <div className="border rounded-lg overflow-hidden bg-white" style={{ height: 'calc(90vh - 300px)' }}>
              <iframe
                srcDoc={generateLightVehicleInvoiceHTML(displayData)}
