...
export function exportLightVehicleReport(data: LightVehicleReportData) {
  ...
  XLSX.writeFile(wb, `LightVehicle_Executive_Report_${new Date().toISOString().slice(0, 10)}.xlsx`);
}
