...
import { LightVehicleReportFilters as FilterType } from '@/hooks/useLightVehicleExecutiveReport';
...
export function LightVehicleReportFilters({ filters, onFiltersChange, availableBusModels }: Props) {
