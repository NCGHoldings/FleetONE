          ...
          <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div><Label>Linked LC</Label><Select value={createForm.lc_id} onValueChange={v => setCreateForm(f => ({ ...f, lc_id: v }))}><SelectTrigger><SelectValue placeholder="None" /></SelectTrigger><SelectContent><SelectItem value="_none">None</SelectItem>{lcs.map(lc => (<SelectItem key={lc.id} value={lc.id}>{lc.lc_no}</SelectItem>))}</SelectContent></Select></div>
