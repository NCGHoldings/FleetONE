...
import { useLightVehicleVehicleDataManagement, ColumnMapping } from '@/hooks/useLightVehicleVehicleDataManagement';
...
export function LightVehicleVehicleDataUpload({ onUploadComplete }: Props) {
  ...
  const { autoDetectColumnMapping, createDataSheet, insertVehicleRecords, isLoading } = useLightVehicleVehicleDataManagement();
  ...
  const handleCreateShipment = async () => {
    ...
    try {
      const { data, error } = await (supabase
        .from('lightvehicle_shipment_groups') as any)
        .insert({
