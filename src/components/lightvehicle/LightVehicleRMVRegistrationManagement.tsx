...
interface LightVehicleRMVRegistrationManagementProps {
  onRefresh: () => void;
}

export function LightVehicleRMVRegistrationManagement({ onRefresh }: LightVehicleRMVRegistrationManagementProps) {
  return (
    <Card>
      <CardHeader>
