...
import { LightVehicleImageGallery } from './LightVehicleImageGallery';
...
interface LightVehicleBusModelProfileProps {
  busModel: BusModel | null;
  isOpen: boolean;
  onClose: () => void;
}

export function LightVehicleBusModelProfile({ busModel, isOpen, onClose }: LightVehicleBusModelProfileProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto space-y-6">
          ...
          {loadingImages ? (
            ...
            <LightVehicleImageGallery images={images} />
          )}
          {/* Header Cards */}
