...
interface LightVehicleOldSalesImportProps {
  onImportComplete: () => void;
}

export const LightVehicleOldSalesImport: React.FC<LightVehicleOldSalesImportProps> = ({ onImportComplete }) => {
  ...
  const { importOldSales } = useLightVehicleOldSalesManagement();
