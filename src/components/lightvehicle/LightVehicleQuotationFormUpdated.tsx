...
export function LightVehicleQuotationForm({ onSubmit, onCancel, initialData }: LightVehicleQuotationFormProps) {
  ...
  const handleFormSubmit = async (data: FormData) => {
    try {
      ...
      toast({
        title: "Success",
        description: "LightVehicle quotation created successfully",
      });
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            Create LightVehicle Bus Quotation
