...
import { useLightVehicleLogisticsManagement, LightVehicleShipment, ShippingDocument, ShipmentTracking } from '@/hooks/useLightVehicleLogisticsManagement';

interface LightVehicleShipmentDetailsModalProps {
  shipment: LightVehicleShipment;
  open: boolean;
  onClose: () => void;
  onRefresh: () => void;
}

export function LightVehicleShipmentDetailsModal({
  shipment,
  open,
  onClose,
  onRefresh
}: LightVehicleShipmentDetailsModalProps) {
