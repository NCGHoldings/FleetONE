...
interface SinotrukInvoiceTemplateSelectorProps {
  selectedTemplateId: string | null;
  onTemplateChange: (template: VehicleSalesTemplate | null) => void;
}

export function SinotrukInvoiceTemplateSelector({
  selectedTemplateId,
  onTemplateChange,
}: SinotrukInvoiceTemplateSelectorProps) {
  const { data: templates, isLoading } = useVehicleSalesTemplates('sinotruck_sales', 'sinotruck_order_invoice');
