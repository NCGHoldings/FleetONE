...
import { SinotrukInvoiceDataModal } from './SinotrukInvoiceDataModal';
import { SinotrukOrderInvoiceViewModal } from './SinotrukOrderInvoiceViewModal';
import { SinotrukInvoiceTypeModal, ProformaInvoiceConfig } from './SinotrukInvoiceTypeModal';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { SinotrukOrderInvoiceData } from '@/lib/sinotruck-order-invoice-generator';

interface SinotrukOrder {
  id: string;
  order_no: string;
  quotation_id?: string;
  bus_model: string;
...
interface SinotrukOrderInvoiceGeneratorProps {
  order: SinotrukOrder;
  onRefresh?: () => void;
}

export function SinotrukOrderInvoiceGenerator({ order, onRefresh }: SinotrukOrderInvoiceGeneratorProps) {
