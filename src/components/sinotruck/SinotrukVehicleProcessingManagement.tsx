...
interface SinotrukVehicleProcessingManagementProps {
  onRefresh: () => void;
}

export function SinotrukVehicleProcessingManagement({ onRefresh }: SinotrukVehicleProcessingManagementProps) {
  return (
    <Card>
      <CardHeader>
