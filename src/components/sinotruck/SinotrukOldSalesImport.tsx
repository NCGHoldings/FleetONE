...
interface SinotrukOldSalesImportProps {
  onImportComplete: () => void;
}

export const SinotrukOldSalesImport: React.FC<SinotrukOldSalesImportProps> = ({ onImportComplete }) => {
  ...
  const { importOldSales } = useSinotrukOldSalesManagement();
