...
import { SinotrukCashReceiptPreview } from './SinotrukCashReceiptPreview';
import { SinotrukCashReceiptSignatureModal } from './SinotrukCashReceiptSignatureModal';
import { SinotrukCashReceipt } from '@/hooks/useSinotrukCashReceipts';
import { Download, Eye, PenTool, RefreshCw } from 'lucide-react';
import html2canvas from 'html2canvas';
import jsPDF from 'jspdf';
import { toast } from 'sonner';

interface SinotrukCashReceiptModalProps {
  isOpen: boolean;
  onClose: () => void;
  receipt: SinotrukCashReceipt | null;
  onRefresh: () => void;
}

export const SinotrukCashReceiptModal = ({
  isOpen,
  onClose,
  receipt,
  onRefresh
}: SinotrukCashReceiptModalProps) => {
  ...
  return (
    <>
          ...
          <Tabs defaultValue="preview" className="w-full">
            ...
            <TabsContent value="preview" className="mt-4">
              <div className="border rounded-lg overflow-hidden">
                <div ref={printRef}>
                  <SinotrukCashReceiptPreview receipt={receipt} />
                </div>
              </div>
            </TabsContent>
          </Tabs>
      ...
      <SinotrukCashReceiptSignatureModal
