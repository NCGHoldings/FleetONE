...
import { useSinotrukSupplierManagement, SinotrukSupplierOrder, ProductionUpdate } from '@/hooks/useSinotrukSupplierManagement';

interface SinotrukSupplierOrderDetailsModalProps {
  supplierOrder: SinotrukSupplierOrder;
  open: boolean;
  onClose: () => void;
  onRefresh: () => void;
}

export function SinotrukSupplierOrderDetailsModal({
  supplierOrder,
  open,
  onClose,
  onRefresh
}: SinotrukSupplierOrderDetailsModalProps) {
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label>Sinotruk Reference</Label>
                    <div className="font-mono text-sm mt-1">
                      {supplierOrder.sinotruck_order_reference || 'Not assigned'}
                    </div>
                  </div>
