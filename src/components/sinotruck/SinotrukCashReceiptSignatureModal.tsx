...
import { useSinotrukCashReceipts } from '@/hooks/useSinotrukCashReceipts';
import { supabase } from '@/integrations/supabase/client';
import { Pencil, Type, Upload, UserCheck } from 'lucide-react';

interface SinotrukCashReceiptSignatureModalProps {
  isOpen: boolean;
  onClose: () => void;
  receiptId: string;
...
export const SinotrukCashReceiptSignatureModal = ({
  isOpen,
  onClose,
  receiptId,
  defaultRole,
  defaultSignerName,
  onSignatureSaved
}: SinotrukCashReceiptSignatureModalProps) => {
  ...
  const { loading, updateReceiptSignature } = useSinotrukCashReceipts();
