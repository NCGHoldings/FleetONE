...
interface SinotruckInvoiceDataModalProps {
  isOpen: boolean;
  onClose: () => void;
  orderId: string;
  existingData?: {
...
export function SinotruckInvoiceDataModal({
  isOpen,
  onClose,
  orderId,
  existingData,
  onSuccess
}: SinotruckInvoiceDataModalProps) {
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g., LZGCL5S9XNXXXXXX"
                required
              />
            </div>
