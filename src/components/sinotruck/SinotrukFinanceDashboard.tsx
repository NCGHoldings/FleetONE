...
import { SinotrukLCManagement } from './SinotrukLCManagement';
import { SinotrukPaymentTracking } from './SinotrukPaymentTracking';
import { SinotrukDeliveryOrderManagement } from './SinotrukDeliveryOrderManagement';
...
export function SinotrukFinanceDashboard() {
  ...
  const { getFinancialDashboard } = useSinotrukFinanceManagement();
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="lc-management">
          <SinotrukLCManagement onRefresh={loadFinancialData} />
        </TabsContent>

        <TabsContent value="payments">
          <SinotrukPaymentTracking onRefresh={loadFinancialData} />
        </TabsContent>

        <TabsContent value="delivery-orders">
          <SinotrukDeliveryOrderManagement onRefresh={loadFinancialData} />
        </TabsContent>
      </Tabs>
    </div>
  );
