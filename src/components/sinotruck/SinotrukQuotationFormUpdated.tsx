...
export function SinotrukQuotationForm({ onSubmit, onCancel, initialData }: SinotrukQuotationFormProps) {
  ...
  const handleFormSubmit = async (data: FormData) => {
    try {
      ...
      toast({
        title: "Success",
        description: "Sinotruk quotation created successfully",
      });
