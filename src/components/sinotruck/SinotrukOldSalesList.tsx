...
import { useSinotrukOldSalesManagement, OldSalesRecord } from '@/hooks/useSinotrukOldSalesManagement';
import { SinotrukOldSalesDetailModal } from './SinotrukOldSalesDetailModal';
import { SinotrukOldSalesConvertModal } from './SinotrukOldSalesConvertModal';
import { format } from 'date-fns';

export const SinotrukOldSalesList: React.FC = () => {
  const { 
    loading, 
    records, 
    fetchOldSales, 
