...
import { SinotrukReportFilters as FilterType } from '@/hooks/useSinotrukExecutiveReport';
...
export function SinotrukReportFilters({ filters, onFiltersChange, availableBusModels }: Props) {
