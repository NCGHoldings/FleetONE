...
import { SinotrukQuotationSignatureModal } from './SinotrukQuotationSignatureModal';
...
interface SinotrukSignatureManagerProps {
  quotationId: string;
  onSignaturesUpdated?: () => void;
}

export const SinotrukSignatureManager = ({ quotationId, onSignaturesUpdated }: SinotrukSignatureManagerProps) => {
  ...
  const { fetchSignatures, deleteSignature } = useSinotrukSignatures();
  ...
  return (
    <>
      ...
      <SinotrukQuotationSignatureModal
        isOpen={isModalOpen}
