...
interface SinotrukCashReceiptPreviewProps {
  receipt: SinotrukCashReceipt;
}

export const SinotrukCashReceiptPreview = forwardRef<HTMLDivElement, SinotrukCashReceiptPreviewProps>(
  ({ receipt }, ref) => {
      ...
      <div ref={ref} style={{ fontFamily: 'Arial, sans-serif', margin: 0, padding: '20px', background: '#f9f9f9', color: '#000' }}>
        ...
        <div className="cash-receipt-page" style={{ border: '2px solid #003366', padding: '0' }}>
          ...
          <div className="receipt-header">
            <img 
              src="/lovable-uploads/sinotruck-cash-receipt-header.png" 
              ...
              <tbody>
                <tr>
                  <td className="amount-cell" style={{ fontSize: '14px', fontWeight: 'bold' }}>
                    {receipt.product_description || 'ADVANCE PAYMENT'}
                  </td>
...
SinotrukCashReceiptPreview.displayName = 'SinotrukCashReceiptPreview';
