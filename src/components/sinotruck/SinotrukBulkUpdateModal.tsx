...
interface SinotrukBulkUpdateModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export function SinotrukBulkUpdateModal({
  open,
  onClose,
  onSuccess,
  shipment
}: SinotrukBulkUpdateModalProps) {
  const [selectedPhase, setSelectedPhase] = useState('');
  const { bulkUpdateOrdersPhase, updateShipmentGroup, isLoading } = useSinotrukShipmentGroupManagement();
