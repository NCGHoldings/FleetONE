...
import { useSinotrukLogisticsManagement, SinotrukShipment, ShippingDocument, ShipmentTracking } from '@/hooks/useSinotrukLogisticsManagement';

interface SinotrukShipmentDetailsModalProps {
  shipment: SinotrukShipment;
  open: boolean;
  onClose: () => void;
  onRefresh: () => void;
}

export function SinotrukShipmentDetailsModal({
  shipment,
  open,
  onClose,
  onRefresh
}: SinotrukShipmentDetailsModalProps) {
