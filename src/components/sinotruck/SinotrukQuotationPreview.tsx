...
import { useSinotrukSignatures, SinotrukSignature } from "@/hooks/useSinotrukSignatures";
...
interface SinotrukQuotationPreviewProps {
  quotation: SinotrukQuotation;
}

export const SinotrukQuotationPreview = forwardRef<HTMLDivElement, SinotrukQuotationPreviewProps>(({ quotation }, ref) => {
  ...
  const [signatures, setSignatures] = useState<SinotrukSignature[]>([]);
  const { fetchSignatures } = useSinotrukSignatures();
      ...
      <div className="page">
        <div className="page-content">
          ...
          <div className="page-header">
            <img
              ...
              alt="Quotation Header - NCG Holdings & Sinotruk"
            ...
            <tbody>
              ...
              <tr>
                <td style={{ padding: "8px", fontSize: "14px", border: "1px solid #003366", whiteSpace: "pre-wrap" }}>
                  <b>BUS{'\u00A0'}MODEL{'\u00A0'}:{'\u00A0'}</b>SINOTRUCK{'\u00A0'}-{'\u00A0'}{busDetails.model}
                  <br />
                  ...
                  {addOns.map((addon, index) => (
                    <tr key={index}>
                      <td style={{ padding: "8px", fontSize: "14px", border: "1px solid #003366" }}>
                        <b>ADD-ON:</b> {addon.sinotruck_addons?.addon_name || "N/A"}
        ...
        <div className="page-footer">
          ...
          <div className="footer-contact">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ✉️ {responsiblePerson?.email || "info@sinotrucklankabus.lk"}
            </div>
            {responsiblePerson && (
...
SinotrukQuotationPreview.displayName = "SinotrukQuotationPreview";
