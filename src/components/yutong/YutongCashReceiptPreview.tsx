...
interface YutongCashReceiptPreviewProps {
  receipt: YutongCashReceipt;
}

export const YutongCashReceiptPreview = forwardRef<HTMLDivElement, YutongCashReceiptPreviewProps>(
  ({ receipt }, ref) => {
...
YutongCashReceiptPreview.displayName = 'YutongCashReceiptPreview';
