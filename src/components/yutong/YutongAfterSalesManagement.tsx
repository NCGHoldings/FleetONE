...
import { useYutongAfterSalesManagement } from '@/hooks/useYutongAfterSalesManagement';
import { format } from 'date-fns';

interface YutongAfterSalesManagementProps {
  onRefresh: () => void;
}

export function YutongAfterSalesManagement({ onRefresh }: YutongAfterSalesManagementProps) {
  const {
    isLoading,
    getWarranties,
    getServiceReminders,
