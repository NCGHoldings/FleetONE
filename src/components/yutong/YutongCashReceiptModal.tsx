...
import { YutongCashReceiptPreview } from './YutongCashReceiptPreview';
import { YutongCashReceiptSignatureModal } from './YutongCashReceiptSignatureModal';
import { YutongCashReceipt } from '@/hooks/useYutongCashReceipts';
import { Download, Eye, PenTool, RefreshCw } from 'lucide-react';
import html2canvas from 'html2canvas';
import jsPDF from 'jspdf';
import { toast } from 'sonner';

interface YutongCashReceiptModalProps {
  isOpen: boolean;
  onClose: () => void;
  receipt: YutongCashReceipt | null;
  onRefresh: () => void;
}

export const YutongCashReceiptModal = ({
  isOpen,
  onClose,
  receipt,
  onRefresh
}: YutongCashReceiptModalProps) => {
  ...
  return (
    <>
          ...
          <Tabs defaultValue="preview" className="w-full">
            ...
            <TabsContent value="preview" className="mt-4">
              <div className="border rounded-lg overflow-hidden">
                <div ref={printRef}>
                  <YutongCashReceiptPreview receipt={receipt} />
                </div>
              </div>
            </TabsContent>
          </Tabs>
      ...
      <YutongCashReceiptSignatureModal
