...
import { YutongReferralHistoryModal } from './YutongReferralHistoryModal';
import { YutongRecordCommissionPaymentModal } from './YutongRecordCommissionPaymentModal';
...
export function YutongReferralManagement() {
  ...
  const loadStats = async () => {
    try {
      // Get commission stats from yutong_referral_commission_payments
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedAgent && (
        <>
          <YutongReferralHistoryModal
            open={showHistoryModal}
            onOpenChange={setShowHistoryModal}
            agent={selectedAgent}
          />
          <YutongRecordCommissionPaymentModal
