...
export function YutongReportShareDialog() {
  ...
  const generateCode = async () => {
    ...
    const { error } = await supabase
      .from('system_settings')
      .upsert({ setting_key: 'yutong_report_access_code', setting_value: newCode as any }, { onConflict: 'setting_key' });
  ...
  const shareUrl = `${window.location.origin}/public/yutong-report?code=${code}`;
