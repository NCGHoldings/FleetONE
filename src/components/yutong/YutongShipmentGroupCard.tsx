...
import { ShipmentGroup } from '@/hooks/useYutongShipmentGroupManagement';
...
interface YutongShipmentGroupCardProps {
...
export function YutongShipmentGroupCard({
  shipment,
  onEdit,
  onDelete,
  onAddOrders,
