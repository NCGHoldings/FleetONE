...
import { YutongQuotationSignatureModal } from './YutongQuotationSignatureModal';
...
interface YutongSignatureManagerProps {
  quotationId: string;
  onSignaturesUpdated?: () => void;
}

export const YutongSignatureManager = ({ quotationId, onSignaturesUpdated }: YutongSignatureManagerProps) => {
  ...
  const { fetchSignatures, deleteSignature } = useYutongSignatures();
