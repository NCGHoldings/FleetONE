...
import { ShipmentGroup, useYutongShipmentGroupManagement } from '@/hooks/useYutongShipmentGroupManagement';
import { YutongShipmentGroupCard } from './YutongShipmentGroupCard';
import { YutongCreateShipmentGroupModal } from './YutongCreateShipmentGroupModal';
import { YutongAddOrdersToShipmentModal } from './YutongAddOrdersToShipmentModal';
import { YutongBulkUpdateModal } from './YutongBulkUpdateModal';
...
export function YutongShipmentGroupManagement() {
  ...
  const { getShipmentGroups, deleteShipmentGroup } = useYutongShipmentGroupManagement();
  ...
  return (
    <>
      ...
      {(showCreateModal || editingShipment) && (
        <YutongCreateShipmentGroupModal
      ...
      {/* Add Orders Modal */}
      {addOrdersShipment && (
        <YutongAddOrdersToShipmentModal
