...
import { OldSalesRecord } from '@/hooks/useYutongOldSalesManagement';
...
interface YutongOldSalesConvertModalProps {
...
export const YutongOldSalesConvertModal: React.FC<YutongOldSalesConvertModalProps> = ({
  record,
  open,
  onClose,
  onConvert,
