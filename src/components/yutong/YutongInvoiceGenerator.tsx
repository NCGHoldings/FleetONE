...
import { type YutongInvoiceData } from '@/lib/yutong-invoice-generator';
import { YutongInvoiceViewModal } from './YutongInvoiceViewModal';
...
export const YutongInvoiceGenerator: React.FC<YutongInvoiceGeneratorProps> = ({
  isOpen,
  onClose,
  quotation,
  onSuccess
  ...
  const handleViewDocument = (document: YutongStoredDocument) => {
