...
import { YutongInvoiceSignatureModal } from './YutongInvoiceSignatureModal';
...
interface YutongInvoiceSignatureManagerProps {
  invoiceRecordId: string;
  onSignaturesUpdated?: () => void;
}

export function YutongInvoiceSignatureManager({
  invoiceRecordId,
  onSignaturesUpdated
}: YutongInvoiceSignatureManagerProps) {
  ...
  const { fetchSignatures, deleteSignature, loading } = useYutongInvoiceSignatures();
  ...
  const renderSignaturePreview = (signature: YutongInvoiceSignature) => {
