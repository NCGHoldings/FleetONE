...
interface YutongInvoiceTemplateSelectorProps {
  selectedTemplateId: string | null;
  onTemplateChange: (template: VehicleSalesTemplate | null) => void;
}

export function YutongInvoiceTemplateSelector({
  selectedTemplateId,
  onTemplateChange,
}: YutongInvoiceTemplateSelectorProps) {
  const { data: templates, isLoading } = useVehicleSalesTemplates('yutong_sales', 'yutong_order_invoice');
