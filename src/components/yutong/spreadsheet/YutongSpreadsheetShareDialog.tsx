...
export function YutongSpreadsheetShareDialog({ open, onOpenChange }: Props) {
  ...
  const saveCode = async () => {
    const { error } = await supabase.from('system_settings').upsert({
      setting_key: 'yutong_spreadsheet_access_code',
  ...
  const shareUrl = `${window.location.origin}/public/yutong-spreadsheet?code=${encodeURIComponent(accessCode)}`;
