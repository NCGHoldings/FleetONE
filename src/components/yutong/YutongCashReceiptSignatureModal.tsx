...
interface YutongCashReceiptSignatureModalProps {
  isOpen: boolean;
  onClose: () => void;
  receiptId: string;
...
export const YutongCashReceiptSignatureModal = ({
  isOpen,
  onClose,
  receiptId,
  defaultRole,
  defaultSignerName,
  onSignatureSaved
}: YutongCashReceiptSignatureModalProps) => {
  ...
  const { loading, updateReceiptSignature } = useYutongCashReceipts();
