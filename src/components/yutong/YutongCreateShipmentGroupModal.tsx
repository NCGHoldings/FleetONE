...
import { useYutongShipmentGroupManagement, ShipmentGroup, CreateShipmentGroupData } from '@/hooks/useYutongShipmentGroupManagement';

interface YutongCreateShipmentGroupModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export function YutongCreateShipmentGroupModal({
  open,
  onClose,
  onSuccess,
  editShipment
}: YutongCreateShipmentGroupModalProps) {
  const isEditing = !!editShipment;
  const { createShipmentGroup, updateShipmentGroup, isLoading } = useYutongShipmentGroupManagement();
