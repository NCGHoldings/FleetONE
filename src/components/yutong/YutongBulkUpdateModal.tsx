...
interface YutongBulkUpdateModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export function YutongBulkUpdateModal({
  open,
  onClose,
  onSuccess,
  shipment
}: YutongBulkUpdateModalProps) {
  const [selectedPhase, setSelectedPhase] = useState('');
  const { bulkUpdateOrdersPhase, updateShipmentGroup, isLoading } = useYutongShipmentGroupManagement();
