...
import { generateYutongInvoiceHTML, type YutongInvoiceData } from '@/lib/yutong-invoice-generator';
import { useYutongInvoiceManagement, type YutongStoredDocument } from '@/hooks/useYutongInvoiceManagement';
...
interface YutongInvoiceViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  invoiceDocument: YutongStoredDocument;
  invoiceData: YutongInvoiceData;
  onRefresh?: () => void;
}

export const YutongInvoiceViewModal: React.FC<YutongInvoiceViewModalProps> = ({
  isOpen,
  onClose,
  invoiceDocument,
  invoiceData,
  ...
  const { approveInvoice, regenerateInvoice, isLoading } = useYutongInvoiceManagement();
  ...
  const displayData: YutongInvoiceData = {
    ...invoiceData,
  ...
  const handlePrint = () => {
    const htmlContent = generateYutongInvoiceHTML(displayData);
        ...
        <DialogHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            <DialogTitle className="text-xl font-semibold">
              Yutong Invoice - {invoiceData.invoiceNo}
            </DialogTitle>
