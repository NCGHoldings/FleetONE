...
import { LeaveManagementSheet } from "@/components/hr/LeaveManagementSheet";
...
export default function HRHub() {
  ...
  useEffect(() => {
    document.title = "HR Hub | NCG Speed";
  }, []);
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Page Header */}
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Human Resources Hub</h1>
        <p className="text-muted-foreground">
          Centralized management for staff, attendance, leave, payroll, and commissions
        </p>
      </div>
      ...
      <Tabs defaultValue="staff" className="space-y-4">
        <TabsList className="bg-muted/50 p-1 flex-wrap h-auto inline-flex">
          <TabsTrigger value="staff" className="flex items-center"><Users className="w-4 h-4 mr-2"/>Staff Directory</TabsTrigger>
          <TabsTrigger value="attendance" className="flex items-center"><Calendar className="w-4 h-4 mr-2"/>Attendance</TabsTrigger>
          <TabsTrigger value="leave" className="flex items-center"><Clock className="w-4 h-4 mr-2"/>Leave Management</TabsTrigger>
          <TabsTrigger value="commissions" className="flex items-center"><TrendingUp className="w-4 h-4 mr-2"/>Commissions</TabsTrigger>
          <TabsTrigger value="payroll" className="flex items-center"><DollarSign className="w-4 h-4 mr-2"/>Payroll</TabsTrigger>
        </TabsList>
