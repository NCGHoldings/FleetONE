...
> Last Updated: 2026-05-19 | Maintained by: pre-push hook (auto) + engineers (manual)
...
| Field | Value |
|-------|-------|
| **Date** | 2026-05-15 03:41:54 UTC |
| **Branch** | `main` |
| **Commit** | `ed04eaf3` |
| **Message** | feat: enhance submission tracking with daily folder management and extended accounting, finance, and route assignment capabilities |
| **Author** | Abisheka |
| **Files Changed** | 62 files |

### Changed Files
```
  ANTIGRAVITY_ncgCHANGELOG.md
  backfill_bank_company_id.ts
  diagnose_missing_je_bank_txn.ts
  scratch_debug_lineage.ts
  src/App.tsx
  src/components/accounting/APInvoiceForm.tsx
  src/components/accounting/BankReconciliationWorksheet.css
  src/components/accounting/BankReconciliationWorksheet.tsx
  src/components/accounting/DrillDownModal.tsx
  src/components/accounting/JournalEntryDetailDialog.tsx
  src/components/accounting/WHTDetailsSheet.tsx
  src/components/accounting/shared/FinanceDocumentPreviewModal.tsx
  src/components/accounting/shared/TransactionLineageDialog.tsx
  src/components/fleet/FleetMasterSpreadsheet.tsx
  src/components/fleet/FleetMasterSpreadsheetCore.tsx
  src/components/lightvehicle/LightVehicleOrdersList.tsx
  src/components/sinotruck/SinotrukOrdersList.tsx
  src/components/special-hire/FinanceApprovalModal.tsx
  src/components/special-hire/GenerateBalanceInvoiceModal.tsx
  src/components/special-hire/SpecialHireFinanceSettlement.tsx
  src/components/system-monitor/VerifyHubView.tsx
  src/components/system-monitor/blueprint_data.ts
  src/components/trips/BusDailyFolderModal.tsx
  src/components/trips/ConductorSubmissionsReview.tsx
  src/components/trips/SubmissionMatrixDashboard.tsx
  src/components/trips/SubmissionTrackingDashboard.tsx
  src/components/yutong/YutongFinanceSettlementHub.tsx
  src/components/yutong/YutongFocChecklistModal.tsx
  src/components/yutong/YutongOrdersList.tsx
  src/components/yutong/YutongVehicleDataUpload.tsx
  src/components/yutong/YutongVehicleRecordCard.tsx
  src/components/yutong/YutongVehicleRecords.tsx
  src/contexts/CrewAuthContext.tsx
  ...
  src/hooks/useSpecialHireFinance.ts
  src/hooks/useTransactionLineage.ts
  src/hooks/useYutongInvoiceManagement.ts
  src/hooks/useYutongOrderManagement.ts
  src/hooks/useYutongVehicleDataManagement.ts
  src/pages/Complaints.tsx
  src/pages/CrewLogin.tsx
  src/pages/PublicConductorUpload.tsx
  supabase/migrations/20260513150000_backfill_vat_18_percent_split.sql
  supabase/migrations/20260513160000_add_wht_category_to_ap_invoices.sql
  supabase/migrations/20260513160000_vat_backfill_test_one_per_module.sql
  supabase/migrations/20260513161000_vat_preview_all_affected.sql
  supabase/migrations/20260513170000_backfill_bank_transactions_company_id.sql
  supabase/migrations/20260514134933_yutong_foc_checklist.sql
  supabase/migrations/20260514170200_public_route_targets.sql
  supabase/migrations/20260514180000_public_bus_assignment.sql
  supabase/migrations/20260514195500_add_crew_pin_code.sql
  supabase/migrations/20260514214500_allow_multiple_routes_for_bus.sql
  supabase/migrations/20260514220000_update_bus_assignment_trip_count.sql
  supabase/migrations/20260514221000_login_crew_member_rpc.sql
  supabase/migrations/20260514221500_update_login_rpc.sql
  supabase/migrations/20260514223000_add_route_leader.sql
  supabase/migrations/20260515000000_backfill_legacy_yutong_orders.sql
  supabase/migrations/step2_vat_test.sql
  supabase/migrations/step3_vat_backfill_apply.sql
```
