-- Migration: Add assigned_bus to staff_registry and update register_crew_member

ALTER TABLE public.staff_registry ADD COLUMN IF NOT EXISTS assigned_bus TEXT;

DROP FUNCTION IF EXISTS public.register_crew_member(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS public.register_crew_member(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
