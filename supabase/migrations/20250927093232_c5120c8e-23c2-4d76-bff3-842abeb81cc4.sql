-- Create a trigger function to automatically add version suffix to new quotations
...
-- Create the trigger
DROP TRIGGER IF EXISTS set_initial_quotation_version_trigger ON public.special_hire_quotations;
CREATE TRIGGER set_initial_quotation_version_trigger
  BEFORE INSERT ON public.special_hire_quotations
  FOR EACH ROW
  EXECUTE FUNCTION public.set_initial_quotation_version();