-- Migration: Update get_public_bus_assignment to return total_allocated_trips
...
BEGIN
    ...
    IF NOT FOUND THEN
        RETURN QUERY SELECT v_default_route AS route_name, ''::TEXT AS driver_name, ''::TEXT AS conductor_name, 0::BIGINT AS total_allocated_trips;
    END IF;
END;
$$;
