-- Migration: Update register_crew_member RPC to accept staff_type and salary_type

ALTER TABLE public.staff_registry ADD COLUMN IF NOT EXISTS pin_code TEXT;
ALTER TABLE public.staff_registry ADD COLUMN IF NOT EXISTS calling_name TEXT;
...
CREATE OR REPLACE FUNCTION public.register_crew_member(
    ...
    p_pin_code TEXT,
    p_staff_type TEXT DEFAULT 'conductor',
...
GRANT EXECUTE ON FUNCTION public.register_crew_member(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO anon;
