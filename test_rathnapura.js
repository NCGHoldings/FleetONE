...
async function test() {
  ...
  else console.log("By Customer Name:", JSON.stringify(data, null, 2));
  ...
  else console.log("By Invoice Number:", JSON.stringify(data2, null, 2));
  ...
  else console.log("By Notes:", JSON.stringify(data3, null, 2));
}
test();
